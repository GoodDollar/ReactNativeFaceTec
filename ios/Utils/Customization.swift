...
final class Customization {
    public static let resultSuccessMessage = "Uploaded successfully";
    ...
    private static let primary = UIColor("#8413F5")
    ...
    static let UICustomization: FaceTecCustomization = {
        ...
        resultScreen.customActivityIndicatorImage = UIImage(named: "loading", in: defaultBundle, compatibleWith: nil)!
